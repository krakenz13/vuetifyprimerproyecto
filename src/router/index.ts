...
const routes: Array<RouteRecordRaw> = [
  ...
  },
  {
    ...
    children: [
      {
        name: 'gestion-estudiantes-estudiantes',
        path: 'estudiantes',
        component: RouteViewComponent,
        children: [
          {
            name: 'gestion-estudiantes-listado-estudiantes',
            path: 'listado',
            component: ListadoEstudiantesComponent,
          },
          {
            name: 'gestion-estudiantes-crear-estudaintes',
            path: 'crear',
            component: createEstudianteComponent,
          },
          {
            name: 'gestion-estudiantes-vista-estudiantes',
            path: 'vista',
